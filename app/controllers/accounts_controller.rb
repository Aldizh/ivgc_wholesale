class AccountsController < ApplicationController
  ...
  def updateAccount
    ...
    if session[:current_login]
      @url = "https://208.65.111.144/rest/Account/get_account_info/{'session_id':'#{@@session_id}'}/{'account_info':{'i_account':'#{session[:i_account]}'}}"
      @result = apiRequest(@url)
    else
      flash[:error] = "Please login to continue!"
      redirect_to root_path
...
#https://208.65.111.144/rest/Account/get_account_info/{"session_id":"95bd4c36c2f629928d3aca1b410d43e5"}/{"i_customer":"1552","i_account":"877771"}
