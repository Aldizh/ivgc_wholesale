...
class AccountsController < ApplicationController
  ...
  def paymentConfirm
    ...
    if details.message != "Success"
      ...
      @url = "https://208.65.111.144/rest/Account/make_transaction/{'session_id':'9dd4eccdcd7b97039fc6ce95e1a68b9f'}/{'i_account':'#{session[:i_account]}', 'amount':'1', 'action':'Manual Payment', 'visible_comment':'test payment', 'internal_comment':'Not Available', 'suppress_notification':'1'}"
      apiRequest(@url)
